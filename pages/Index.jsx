      ...
      <main className="main-content flex flex-col flex-1" id="top">
        ...
        >
          <div className="hero-content text-white flex flex-col gap-10 lg:gap-20 mt-110">
            ...
            <div className="flex items-center justify-center mt-8">
              <Link
                to="/gallery"
                className="flex items-center gap-8 text-[1.4rem] text-text-foreground bg-tertiary rounded-lg px-12 py-8 cursor-pointer hover:bg-tertiary/80 transition-colors duration-300 ease-in-out capitalize font-medium"
              >
                Explore the Gallery
        ...
        <section className="bg-secondary py-48">
          ...
          <div class="flex justify-center mt-[4.8rem]">
            <Link
              to="/gallery"
              class="flex items-center gap-8 capitalize text-inherit text-[1.4rem] bg-background transition-all duration-300 ease-in-out py-6 px-12 rounded-xl border border-border hover:bg-tertiary"
            >
              view full gallery
              <FaArrowRightLong className="text-[1.6rem]" />
            </Link>
